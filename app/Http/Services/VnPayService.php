...
class VnpayService
{
    public function getVnpayUrl($paymentMethod): string{
        date_default_timezone_set('Asia/Ho_Chi_Minh');
        $vnp_TxnRef = (string)$paymentMethod->id; //Mã giao dịch thanh toán tham chiếu của merchant
        $vnp_Amount = $paymentMethod->total; // Số tiền thanh toán
